In the notebook you will find a neural network written using numpy (and pyplot for plotting) which takes 3D data in the form [x, y, z] and tries to predict future z from x and y.
